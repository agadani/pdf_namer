...
def guess_title():
  ...
  bad_title_first_words=[' USA','Proceedings of','LETTER','Journal of','ARTICLE','Communicated_by','anuscript','Public Access',' S ','USENIX','PERSPECTIVES','Brevia','COMMUN ','PHYSICAL REVIEW','Conference','Symantec Research','Symposium','Vol.','IEEE','Editors','Published by','Published in','Permissions','email','doi:']
